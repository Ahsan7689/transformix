...
const FEATURES = [
  ...
  },
  {
    ...
    to: '/imagine',
    color: '#F89B9B',
    desc: 'Describe any image and let Gemini AI bring it to life. From photorealistic scenes to abstract art — your imagination is the limit.',
    formats: ['Photorealistic', 'Digital Art', 'Anime', 'Abstract', 'Illustration'],
    stat: 'Gemini',
    statLabel: 'Powered by Google AI',
  },
]
